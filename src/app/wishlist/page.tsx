...
//             title: "Ошибка",
//             description:
//               data.message || "Не удалось удалить товар из списка желаний",
//             variant: "destructive",
//           });
//         }
//       }
...
//           title: "Ошибка",
//           description:
//             "Произошла ошибка при удалении товаров из списка желаний",
//           variant: "destructive",
//         });
//       }
//     } finally {
...
//               <button
//                 className="absolute top-3 right-3 z-10 p-2 bg-white/80 rounded-full hover:bg-white cursor-pointer transition-colors"
//                 onClick={() => addToWishlist(1524783641, product.id)}
//                 aria-label="Remove from wishlist"
//                 disabled={removingProductIds.includes(product.id) || isRemoving}
//               >
//                 {removingProductIds.includes(product.id) ? (
