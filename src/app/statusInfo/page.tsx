      ...
      <>
        ...
        <div className="space-y-6 sm:space-y-8 mt-4">
          <div className="flex justify-between">
            <p className="text-[#5F5F5F] font-medium text-sm sm:text-base">ID Заказа : 430960</p>
          ...
          <div className="flex justify-between">
            ...
            <p className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusColor("delivery")}`}>В пути</p>
          </div>
          <div className="flex justify-between">
            <p className="text-[#5F5F5F] font-medium text-sm sm:text-base">Дата покупки</p>
            <p className="text-[#1B1B1B] font-bold text-sm sm:text-base">Воскресенье, 9 октября <br />2022 г., 10:12 утра</p>
          </div>
          <div className="flex justify-between">
            <p className="text-[#5F5F5F] font-medium text-sm sm:text-base">дата доставки</p>
            <p className="text-[#1B1B1B] text-sm sm:text-base">Воскресенье, 9 октября <br />2022 г., 10:12 утра</p>
          </div>
          <div className="flex justify-between border-b pb-5">
            <p className="text-[#5F5F5F] font-medium text-sm sm:text-base">Счет</p>
            <p className="text-[#FF385C] text-sm sm:text-base">ИНВ/20221114/MPL/28203158839</p>
          </div>
          <div className="flex justify-between">
            <p className="text-[#5F5F5F] font-medium text-sm sm:text-base w-1/2">адрес доставок пункт выдачи</p>
            <p className="text-[#1B1B1B] font-bold text-sm sm:text-base w-1/2">Blk. A-B Jl. Cikutra No.125,
              Cikutra, Kec. Cibeunying Kidul,
              Charlotte, North Carolina 40124</p>
          </div>
          <h1 className='font-semibold mb-2 text-base sm:text-lg"'>Подробности продукта</h1>
          <div className="flex my-4 py-4 pr-2 md:pr-10 flex-wrap md:flex-nowrap gap-3 sm:gap-4 border-b min-h-[120px] sm:min-h-[160px]">
            ...
            <div className="flex-1 flex flex-col justify-between space-y-5">
              <h4 className="font-bold text-sm sm:text-base">
                ...
                <span className='text-[#1B1B1BB2] font-medium text-[13px] sm:text-[14px]'>Платье с цветочным принтом</span>
              </h4>
              ...
              <div className='flex items-center gap-2 justify-between'>
                ...
                <p className="font-medium md:hidden block">$ 2000</p>
              </div>
            </div>
            <div className="flex md:w-max w-full items-center justify-between font-semibold text-sm sm:text-base gap-4">
              ...
              <p className="font-medium md:block hidden ">$ 20000</p>
            </div>
          </div>
          <div className="mt-4">
            <h4 className="font-semibold mb-2 text-base sm:text-lg">Детали платежа</h4>

            <>
              <div className="flex justify-between">
                <span className="text-[#5F5F5F] font-medium text-base">Всего покупок</span>
                <span className="text-[#1B1B1B] font-bold text-base">$2000</span>
              </div>
              ...
              <div className="flex justify-between mt-3">
                ...
                <span className="text-[#1B1B1B] font-bold text-base">$20</span>
              </div>
              ...
              <div className="flex justify-between mt-3">
                ...
                <span className="font-bold text-base">$ 1.570.00</span>
              </div>
            </>
            <Link href='/congratulations'>
              <Button className='w-full bg-[#FF385C] rounded-2xl mt-6 h-12 capitalize'>помощь</Button>
            </Link>
          </div>
        </div>
      </>
