                  ...
                  >
                    <div className="w-20 h-20 bg-gray-100 rounded-lg flex items-center justify-center">
                      {item.product_images && item.product_images.length > 0 ? (
                        <Image
                          src={
                            item.product_images[0].image || "/placeholder.svg"
                          }
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-gray-400 mt-1">
                        Item ID: {item.id} | Product ID: {item.product}
                      </div>
...
//       // Set default shipping method if available
//       if (data.available_shipping_methods && data.available_shipping_methods.length > 0) {
//         setSelectedShippingMethod(data.available_shipping_methods[0])
//       }
//     } catch (error) {
//       console.error("Error fetching cart:", error)
...
//   const isFormValid = customerName.trim() !== "" && phoneNumber.trim() !== "" && selectedBranch !== null
...
//                           size="sm"
//                           className="h-8 w-8 p-0"
//                           onClick={() => updateQuantity(item.id, item.product, item.quantity - 1)}
//                           disabled={isUpdating || item.quantity <= 1}
//                         >
//                           <Minus className="h-4 w-4" />
//                         </Button>
...
//             {/* Shipping Methods */}
//             {cart.available_shipping_methods && cart.available_shipping_methods.length > 0 && (
//               <div className="bg-gray-50 p-6 rounded-lg">
...
//                       key={method.id}
//                       variant="outline"
//                       className={`${selectedShippingMethod?.id === method.id ? "border-[#FF3A5C] bg-red-50" : ""} px-4 py-2 h-auto`}
//                       onClick={() => setSelectedShippingMethod(method)}
//                     >
//                       <div className="text-center flex gap-2 items-center">
//                         <span className="text-base font-semibold">
